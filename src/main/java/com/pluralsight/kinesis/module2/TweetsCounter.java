...
public class TweetsCounter implements IRecordProcessor {
    ...
    //Fake DB
    static private TwitterAnalyticsDb twitterAnalyticsDb = new TwitterAnalyticsDb();
  ...
  //  private twitter4j.Status parseTweet(String tweetJson) {
    private Status parseTweet(String tweetJson){
        try {
            return TwitterObjectFactory.createStatus(tweetJson);
           // return (Status) TwitterObjectFactory.createStatus(tweetJson);
    ...
    public void shutdown(ShutdownInput shutdownInput){
        ...
        switch (reason){
            ...
            case REQUESTED:
                ...
                break;
            case ZOMBIE:
                log("Zombie chard. No checkpoint.");
                break;
        }
    }
